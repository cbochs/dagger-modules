...
// Load a RemoteCacheBackend from its ID.
func (r *Query) LoadRemoteCacheBackendFromID(id RemoteCacheBackendID) *RemoteCacheBackend {
	q := r.query.Select("loadRemoteCacheBackendFromID")
	q = q.Arg("id", id)
